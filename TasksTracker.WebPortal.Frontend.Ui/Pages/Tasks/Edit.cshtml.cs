...
namespace TasksTracker.WebPortal.Frontend.Ui.Pages.Tasks
{
    public class EditModel : PageModel
    {
        ...
        [BindProperty]
        public UpdateTaskModel? TaskUpdate { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync(Guid? id)
        {
            ...
            var Task = await _daprClient.InvokeMethodAsync<TaskModel>(HttpMethod.Get, "tasksmanager-backend-api", $"api/task/{id}");
            ...
            TaskUpdate = new UpdateTaskModel()
            {
                TaskId = Task.TaskId,
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (TaskUpdate != null)
            {
                await _daprClient.InvokeMethodAsync(HttpMethod.Put, "tasksmanager-backend-api", $"api/task/{TaskUpdate.TaskId}", TaskUpdate);
            }
