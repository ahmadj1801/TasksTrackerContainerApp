...
namespace TasksTracker.WebPortal.Frontend.Ui.Pages.Tasks
{
    public class IndexModel : PageModel
    {
        ...
        public IndexModel(IHttpClientFactory httpClientFactory, Dapr.Client.DaprClient daprClient)
        {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {     // Invoke via internal URL (Not Dapr)
                ...
                TasksList = await _daprClient.InvokeMethodAsync<List<TaskModel>>(HttpMethod.Get, "tasksmanager-backend-api", $"api/task?createdBy={TasksCreatedBy}");
        ...
        {
            await _daprClient.InvokeMethodAsync(HttpMethod.Delete, "tasksmanager-backend-api", $"api/task/{id}");
            return RedirectToPage();
        }

        public async Task<IActionResult> OnPostCompleteAsync(Guid id)
        {
            await _daprClient.InvokeMethodAsync(HttpMethod.Put, "tasksmanager-backend-api", $"api/task/{id}/markcomplete");
            return RedirectToPage();
        }
    }
}
